                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-{{ $product->status == 'hiện' ? 'success' : 'secondary' }}">
                                            {{ $product->status }}
                                        </span>
                                    </td>
                                </tr>
                    ...
                    <div class="mt-4 p-3 bg-light rounded">
                        <small class="text-muted">
                            ...
                            <div><strong>Cập nhật lần cuối:</strong> {{ $product->updated_at->format('d/m/Y H:i') }}</div>
                        </small>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format($order->pivot->quantity * $order->pivot->price, 0, ',', '.') }} đ</td>
                                    <td>
                                        @php
                                            $statusClass = [
                                                'pending' => 'warning',
