...
<div class="container-fluid py-4">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.product.show', $product->product_id) }}" class="text-decoration-none">{{ $product->product_name }}</a></li>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form action="{{ route('admin.product.update', $product->product_id) }}" method="POST" enctype="multipart/form-data" id="editProductForm">
                @csrf
                @method('PUT')
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <span class="form-control bg-light">{{ $product->category->category_name ?? 'N/A' }}</span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control bg-light" 
                                           id="stock" value="{{ $product->stock }}" disabled>
                                    <div class="form-text">Tồn kho được cập nhật tự động qua phiếu nhập và đơn hàng</div>
                                </div>
                            ...
                            <div class="row" id="detail-fields">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @php
                                        ...
                                        $inputType = 'text';
                                        $step = '1';
                                        if (str_contains($attribute, 'kich_thuoc') || str_contains($attribute, 'kích_thước')) {
                                            $inputType = 'number';
                                            $step = '0.1';
                                        } elseif (str_contains($attribute, 'dung_luong') || str_contains($attribute, 'dung_lượng') || 
                                                 str_contains($attribute, 'ram') || str_contains($attribute, 'price') || 
                                                 str_contains($attribute, 'gia') || str_contains($attribute, 'giá')) {
                                            $inputType = 'number';
                                        }
                                    @endphp
                                    <input type="{{ $inputType }}" 
                                           class="form-control @error("details.$attribute") is-invalid @enderror" 
                                           id="detail_{{ $attribute }}" 
