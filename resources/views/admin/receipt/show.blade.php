...
<div class="container-fluid py-4">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.receipt.index') }}" class="text-decoration-none">Phiếu nhập</a></li>
                    ...
                    <div class="timeline">
                        <div class="timeline-item {{ $receipt->status == 'đã hủy' ? 'text-danger' : 'text-success' }}">
                            ...
                            <div class="timeline-content">
                                <small class="text-muted">{{ \Carbon\Carbon::parse($receipt->order_date)->format('d/m/Y H:i') }}</small>
                        ...
                        <div class="timeline-item text-success">
                            <div class="timeline-marker bg-success"></div>
                            <div class="timeline-content">
                                <small class="text-muted">{{ \Carbon\Carbon::parse($receipt->updated_at)->format('d/m/Y H:i') }}</small>
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                      {{-- {{ route('admin.receipt.edit', $receipt->receipt_id) }} --}}
                        <a href="" 
                           class="btn btn-outline-primary btn-sm {{ $receipt->status != 'đang chờ' ? 'disabled' : '' }}">
