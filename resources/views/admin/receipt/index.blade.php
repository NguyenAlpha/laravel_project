                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $receipts->count() ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $receipts->totalPendingReceipts ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $receipts->totalReceivedReceipts ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $receipts->total_cancelled_receipts ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
            ...
            <form action="{{ route('admin.receipt.index') }}" method="GET" id="filterForm" class="row g-3">
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control" id="search" name="search" 
                           value="{{ request('search') }}" placeholder="Mã phiếu nhập...">
                </div>
                <div class="col-md-3">
        ...
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="#" id="bulkUpdateStatus"><i class="fas fa-sync"></i> Cập nhật trạng thái hàng loạt</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="#" id="exportReceipts"><i class="fas fa-file-excel"></i> Xuất Excel</a></li>
                    <li><a class="dropdown-item" href="#" id="printReceipts"><i class="fas fa-print"></i> In danh sách</a></li>
                </ul>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr data-receipt-id="{{ $receipt->receipt_id }}">
                            <td class="text-center">
                                ...
                                <br>
                                {{-- <small class="text-muted">PN-{{ str_pad($receipt->receipt_id, 6, '0', STR_PAD_LEFT) }}</small> --}}
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="fw-bold text-dark">{{ $receipt->supplier->supplier_name ?? 'N/A' }}</div>
                            ...
                            <td class="text-center">
                                <div class="text-dark">{{ \Carbon\Carbon::parse($receipt->order_date)->format('d/m/Y') }}</div>
                                <small class="text-muted">{{ \Carbon\Carbon::parse($receipt->order_date)->format('H:i') }}</small>
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-end">
                                <strong class="text-success">{{ number_format($receipt->total_amount, 0, ',', '.') }}đ</strong>
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-center">
                                {{-- <div class="btn-group btn-group-sm" role="group"> --}}
                                    ...
                                    @if($receipt->status == 'đang chờ')
                                        <button type="button" 
                                                ...
                                                data-receipt-code="#{{ $receipt->receipt_id }}"
                                                data-action="received">
                                            <i class="fas fa-check"></i>
                                        </button>
                                        <button type="button" 
                                                class="btn btn-danger update-status" 
                                ...
                                <!-- Delete Modal -->
                                <div class="modal fade" id="deleteModal{{ $receipt->receipt_id }}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Bạn có chắc chắn muốn xóa phiếu nhập <strong>#{{ $receipt->receipt_id }}</strong>?</p>
                                                <div class="alert alert-warning">
                                                    <small>
                                                        <i class="fas fa-exclamation-triangle me-2"></i>
                                                        Tất cả chi tiết phiếu nhập sẽ bị xóa. Hành động này không thể hoàn tác!
                                                    </small>
                                                </div>
                                            </div>
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
                <div class="text-muted">
                    Hiển thị {{ $receipts->firstItem() ?? 0 }} - {{ $receipts->lastItem() ?? 0 }} của {{ $receipts->total() }} phiếu nhập
                </div>
                <nav>
            ...
            <div class="modal-body">
                <form id="statusForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-control" id="newStatusText" style="background-color: #f8f9fa; font-weight: bold;"></div>
                    </div>
                    {{-- <div class="mb-3">
